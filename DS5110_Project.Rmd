...
**Interpretation:** If the net_price coefficient is statistically significant (p < 0.05) and the partial F-test shows a significant improvement, H1 is supported — net price predicts earnings even after accounting for selectivity.
...
**Interpretation:** If adding field-of-study variables substantially increases R² and the partial F-test is significant, H3 is supported — field matters beyond institution alone.
